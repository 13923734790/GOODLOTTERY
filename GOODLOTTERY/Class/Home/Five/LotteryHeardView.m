...
#define count 6
@interface LotteryHeardView () <UIScrollViewDelegate>
...
@end
@implementation LotteryHeardView
...
- (void)prepareScollView {
    CGFloat scrollW = FRAMEWIDTH;
    CGFloat scrollH = FRAMEHEIGHT;
    ...
    firstImage.image = [UIImage imageNamed:@"img_06"];
...
//    CGFloat pageW = 100;
    UIPageControl *pageView = [[UIPageControl alloc] initWithFrame:CGRectMake(0, FRAMEHEIGHT-10, FRAMEWIDTH, 4)];
