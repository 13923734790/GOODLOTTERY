...
-(void)btClick
{
    ...
    UIButton *but = [self viewWithTag:101];
    but.selected = YES;
    if (self.blockNub)
    {
        _blockNub(99);
    ...
    self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, UIScreenWIDTH, 690*ScaleY+40*ScaleX);
