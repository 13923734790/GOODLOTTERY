...
{
    NSArray *array1 = @[@"游戏玩法",@"投注金额",@"中奖金额"];
    NSArray *array2 = @[@"开奖号码",@"状态",@"用户"];
    ...
    if (self)
    {
        ...
        for (int i = 0; i<3; i++)
        {
            ...
            if (i==1) lable2.textColor = DTAISCOLORE(239, 65, 73, 1),lable4.textColor = DTAISCOLORE(63, 136, 37, 1);
            if (i==2) lable2.textColor =DTAISCOLORE(63, 136, 37, 1);
        ...
        UILabel *BetNubTitle = [[blackAndwhiteLable alloc]initWithFrame:CGRectMake(5,20*ScaleY+20*ScaleY*3,UIScreenWIDTH/6+15*ScaleX,20)];
        UILabel *BetContentTitle = [[blackAndwhiteLable alloc]initWithFrame:CGRectMake(5,20*ScaleY+20*ScaleY*4,UIScreenWIDTH/6+15*ScaleX,20)];
        BetNubTitle.text = @"注单编号";
        BetContentTitle.text = @"投注内容";
        BetNublable = [[blackAndwhiteLable alloc]initWithFrame:CGRectMake(UIScreenWIDTH/6+15*ScaleX,20*ScaleY+20*ScaleY*3,UIScreenWIDTH*5/6-15*ScaleX,20)];
        BetNublable.textColor = DTAISCOLORE(29, 89, 234, 1);
        BetContentLable  = [[blackAndwhiteLable alloc]initWithFrame:CGRectMake(UIScreenWIDTH/6+15*ScaleX,20*ScaleY+20*ScaleY*4,UIScreenWIDTH*5/6-15*ScaleX,20)];
...
{
    NSArray *array1 = @[@"后三直选",@"100000.00元",@"1000000.00元"];
    NSArray *array2 = @[@"54921",@"以派奖",@"SuperZachMan"];
    for (int i = 0; i<3; i++)
    {
